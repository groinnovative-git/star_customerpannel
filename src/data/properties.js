...
const properties = [
  ...
  {
    id: 13,
    name: 'North-Front Apartment',
    location: 'R.S. Puram',
    city: 'Coimbatore',
    price: 4800000,
    priceLabel: '₹ 48,00,000',
    type: 'Apartment',
    bhk: '2 BHK',
    beds: 2,
    baths: 2,
    ...
    loanSupport: true,
    image: prop13,
    images: [prop13, prop14, prop1, prop2, prop3],
    amenities: ['CCTV', 'Lift', 'Parking', 'Power Backup', 'Security'],
    description: 'A premium north-facing apartment in the heart of R.S. Puram with excellent natural lighting and ventilation.'
  },
  {
    id: 14,
    name: 'Blue Diamond Villa',
    location: 'Saravanampatti',
    city: 'Coimbatore',
    price: 9200000,
    priceLabel: '₹ 92,00,000',
    type: 'Villa',
    bhk: '4 BHK',
    beds: 4,
    baths: 4,
    ...
    loanSupport: true,
    image: prop14,
    images: [prop14, prop1, prop2, prop3, prop4],
    amenities: ['Private Garden', 'Swimming Pool', 'Gaming Zone', 'Security', 'Clubhouse'],
    description: 'Exquisite 4 BHK Villa with ultra-modern features. Blue Diamond offers the pinnacle of luxury living in Saravanampatti.'
  },
  {
    id: 15,
    name: 'Green Field Plot',
    location: 'Vadavalli',
    city: 'Coimbatore',
    price: 3500000,
    priceLabel: '₹ 35,00,000',
    type: 'Plot',
    bhk: 'N/A',
    beds: 0,
    baths: 0,
    ...
    loanSupport: true,
    image: prop15,
    images: [prop15, prop16, prop17, prop4, prop5],
    amenities: ['DTCP Approved', 'Avenue Trees', 'Street Lights', 'Water Connection', 'Park'],
    description: 'Prime residential plot in Vadavalli, ideal for investment or building your custom home in a serene environment.'
  },
  {
    id: 16,
    ...
    loanSupport: true,
    image: prop16,
    images: [prop16, prop17, prop18, prop6, prop7],
    amenities: ['Terrace Garden', 'Modular Kitchen', 'Compound Wall', 'Safety Grill', 'Car Parking'],
    description: 'Classic independent house in Kovaipudur with modern amenities and a peaceful neighborhood for your family.'
  },
  {
    id: 17,
    name: 'Silver Oak Apartment',
    location: 'Peelamedu',
    city: 'Coimbatore',
    price: 5200000,
    ...
    loanSupport: true,
    image: prop17,
    images: [prop17, prop18, prop19, prop1, prop2],
    amenities: ['Power Backup', 'Lift', 'Parking', 'Intercom', 'Solar Water'],
    description: 'Spacious 3 BHK apartment in Peelamedu, close to major schools and tech parks. Perfect for working professionals.'
  },
  {
    id: 18,
    ...
    loanSupport: true,
    image: prop18,
    images: [prop18, prop19, prop1, prop2, prop3],
    amenities: ['Fencing', 'Borewell', 'Electricity', 'Water Connection', 'Truck Access'],
    description: 'Strategically located commercial plot on Pollachi Road, ideal for warehouses, workshops or small scale industrial units.'
  }
];
